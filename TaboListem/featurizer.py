...
class Featurizer(object):
    ...
    def __init__(self, train=None, model=None, extrachem=None, bert_pretrain_path='dmis-lab/biobert-base-cased-v1.2'):#'allenai/scibert_scivocab_cased'):#'dmis-lab/biobert-base-cased-v1.2'):#"bert-base-cased"):#"path/to/biobert"):
        """
    ...
    def _load_dicts(self):
        ...
        f = open("TaboListem/MetaboliteNames.txt", "r", encoding="utf-8", errors="replace")
        self.tokenizer = AutoTokenizer.from_pretrained('dmis-lab/biobert-base-cased-v1.2')#'allenai/scibert_scivocab_cased')#'dmis-lab/biobert-base-cased-v1.2')#'bert-base-cased')#self.bert_pretrain_path)
        for l in f:
            l = l.strip()
            if len(l) > 0:
